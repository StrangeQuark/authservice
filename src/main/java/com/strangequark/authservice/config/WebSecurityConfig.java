    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/user/get-admin-user").hasAuthority("USER_MANAGEMENT")
                        .requestMatchers("/api/auth/user/update-role").hasAuthority("USER_MANAGEMENT")
                        .requestMatchers("/api/auth/user/add-authorizations-to-user", "/api/auth/user/remove-authorizations")
                        .hasAuthority("USER_MANAGEMENT")
                        .requestMatchers(HttpMethod.GET, "/api/auth/authorization/get-all", "/api/auth/role-authorization/get-all-roles")
                        .hasAnyAuthority("USER_MANAGEMENT", "AUTHORIZATION_MANAGEMENT")
                        .requestMatchers("/api/auth/authorization/**", "/api/auth/role-authorization/**")
                        .hasAuthority("AUTHORIZATION_MANAGEMENT")
